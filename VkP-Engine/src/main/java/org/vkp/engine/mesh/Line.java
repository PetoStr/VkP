...
public class Line extends Mesh {
	...
	public Line(BufferCreator bufferCreator, StagingBufferCommand stagingBufferCommand) {
		super(bufferCreator, stagingBufferCommand);

		ByteBuffer vertexData = memAlloc(6 * 4 * 4);
		FloatBuffer fb = vertexData.asFloatBuffer();
		fb.put(0.0f).put(-0.5f).put(0.0f).put(1.0f).put(0.0f).put(0.0f);
		fb.put(0.0f).put(0.5f).put(0.0f).put(1.0f).put(0.0f).put(1.0f);
		fb.put(1.0f).put(-0.5f).put(0.0f).put(1.0f).put(1.0f).put(0.0f);
		fb.put(1.0f).put(0.5f).put(0.0f).put(1.0f).put(1.0f).put(1.0f);
		fb.flip();
