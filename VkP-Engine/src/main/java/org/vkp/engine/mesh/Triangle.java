...
public class Triangle extends Mesh {
	...
	public Triangle(BufferCreator bufferCreator, StagingBufferCommand stagingBufferCommand) {
		super(bufferCreator, stagingBufferCommand);

		ByteBuffer vertexData = memAlloc(6 * 3 * 4);
		...
		ByteBuffer indices = memAlloc(3 * 4);
